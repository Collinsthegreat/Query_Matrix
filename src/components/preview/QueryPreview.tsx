...
const MonacoEditor = dynamic(() => import("@monaco-editor/react").then((mod) => mod.default), {
  ssr: false,
  loading: () => <div className="grid h-[300px] place-items-center rounded bg-[var(--bg-input)] text-sm text-[var(--text-secondary)]">Loading editor...</div>
});
...
export function QueryPreview() {
  ...
  return (
    <section className="rounded-lg border border-[var(--border)] bg-[var(--bg-card)] p-3" aria-label="Query preview">
